    ...
    const std::string& reason)
{
    ...
    spdlog::error("Please run the MGSPatriotFix Config Tool to update your settings file to the latest version.");
    ...
    std::cout << "Please run the MGSPatriotFix Config Tool to update your settings file to the latest version." << std::endl;
