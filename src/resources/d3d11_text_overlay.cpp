...
void D3D11TextOverlay::Tick()
{
    ...
    if (bShowUpdateNotification && (bNewUpdateAvailable || bDebugBuild))
    {
        ...
        if (bNewUpdateAvailable)
        {
            ...
            DrawFading("A new version of MGSPatriotFix is available for download!", x_pos, y_pos, 6.0f, 1.0f, {160, 160, 160, 255}, {0, 0, 0, 255}, 1.0f, 0.5, 1.5f, versionFade, TextHorizontalAlignment::Center, TextVerticalAlignment::Center);
        }
        else
        {
            Draw(("MGSPatriotFix Nightly Build v" + sFixVersion).c_str(), x_pos, y_pos, 6.0f, 1.0f, {160, 160, 160, 255}, {0,0,0,0}, TextHorizontalAlignment::Center, TextVerticalAlignment::Center);
        }
    }
