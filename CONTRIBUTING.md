...
Please make all pull requests towards the GitHub repo located at https://github.com/ShizCalev/MGSPatriotFix.git
...
![Signature Maker usage](https://raw.githubusercontent.com/dotlessone/MGSPatriotFix-Media/refs/heads/main/Guides/Signature_Maker_usage.png)
...
If you need to enable this logging, in the MGSPatriotFix Config Tool, go to `MGSPatriotFix / Internal` -> `Internal Settings` -> `Debug Logging`
...
https://github.com/Lyall/MGSPatriotFix/blob/master/src/resources/gamevars.cpp
